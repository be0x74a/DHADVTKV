...
public class WaitingStabilityTransaction {
    ...
    public WaitingStabilityTransaction(long transactionID, long snapshot, List<Long> getKeys, List<DataObject> puts, int nValidations, int client, boolean conflicts) {
